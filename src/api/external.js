...
export function externalRefFieldQuery(externalFormId, field, pageNo, pageSize, queryText, extraFilter, sort) {
    return http.get('/external/refFieldQuery', { externalFormId, 'refField': field, pageNo, pageSize, queryText, extraFilter, sort });
}
