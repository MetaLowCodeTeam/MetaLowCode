...
export function refFieldQuery2(entity, field, pageNo, pageSize, extraFilter, formFilter, formFilter2, sort, referenceEntityName, queryText = "") {
	return http.post(
		'crud/refFieldQuery2',
		[formatFilterToBase64(formFilter), formatFilterToBase64(formFilter2)],
		{
			params: { entity, 'refField': field, pageNo, pageSize, sort, referenceEntityName, queryText },
            headers: {
                extraFilter
            }
		}
 ...
 * @param {*} queryThirdReference 获取第三层的引用字段（需要queryReference = true 才生效）
 */
export function queryEntityFields(
    entityCode, 
    queryReference, 
    queryReserved, 
    firstReference, 
    ...
    return http.get('/crud/queryEntityFields', { 
        entityCode, 
        queryReference, 
        queryReserved, 
        firstReference, 
