...
export default {
    ...
    methods: {
        ...
        onDragAdd(evt, subList) {
            ...
            // let inx = this.layout.length;
            // this.layout.push({ x: 0, y: 0, w: 4, h: 3, i: inx });
            // this.dataList.push({ id: inx, cont: "内容+" + inx });
            // this.layout.push({ x: 0, y: 0, w: 4, h: 3, i: this.layout.length });
            ...
            // this.layout = [];
            // this.layout = subList.map((el, inx) => {
            //     // let { w, h } = el.options.layoutConf;
            //     let layoutConf = {
            //         x: 0,
            //         y: 0,
            //         w: 4,
