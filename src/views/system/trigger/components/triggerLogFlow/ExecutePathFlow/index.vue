...
<template>
    ...
    >
        <div class="box-scale">
            <node-wrap v-if="nodeConfig" v-model="nodeConfig" :executePath="executePath" @error-click="errorClick"></node-wrap>
            <div class="end-node">
...
.sc-workflow-design {
    ...
    .auto-judge .title .title-left .node-title {
        display: inline-block;
        max-width: 120px;
        overflow: hidden;
        white-space: nowrap;
