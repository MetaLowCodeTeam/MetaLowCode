<template>
	<el-form-item label="onRecordSelected" label-width="150px">
		<el-button type="info" icon="el-icon-edit" plain round :class="[eventHandled ? 'button-text-highlight' : '']"
				   @click="editEventHandler('onRecordSelected', eventParams)">
...
export default {
	...
	data() {
		return {
			eventParams: ['selectedRow', 'allSelectedRows'],
		}
	}
}
</script>
